...
class GlobalDeclare
{
  ...
  public static function ProspectosLabel($data = [])
  {
    ...
    if ($slevel == "Under Graduate") {
      switch ($syear) {
        case 1:
          $indi_year2 = "First Year";
          break;
        case 2:
          $indi_year2 = "Second Year";
          break;
        case 3:
          $indi_year2 = "Third Year";
          break;
        case 4:
          $indi_year2 = "Fourth Year";
          break;
        case 5:
          $indi_year2 = "Fift Year";
          break;
      }
      ...
      switch ($syear) {
        case 1:
          $indi_year2 = "I. BASIC COURSES";
          break;
        case 2:
          $indi_year2 = "II. MAJOR COURSES";
          break;
        case 3:
          $indi_year2 = "III. ELECTIVE COURSES";
          break;
        case 4:
          $indi_year2 = "IV. FOREIGN LANGUAGES";
          break;
        case 5:
          $indi_year2 = "V. DISSERTATION";
          break;
      }
      $str = $indi_year2;
