    ...
    <div class="modal-dialog modal-m">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" id="eventModalLabel">Scuaa History</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-hover datatable" id="scuaa-table">
                            <thead>
                                <tr>
                                    <td class="text-nowrap pe-5">#</td>
                                    <th class="text-nowrap">Scuaa Event</th>
                                </tr>
                            </thead>
                            <tbody id="data">
                                @include('_partials.history-table')
                            </tbody>
                        </table>
