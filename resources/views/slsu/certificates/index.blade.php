            ...
            <div class="card m-0">
                ...
                <div class="card-body">
                    <form id = "frmGenerate">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-12 mb-3">
                                <label for="allsearch" class="form-label">Search Name / Student: <span
                                        class = "text-danger">*</span></label>
                                <input type="text" id="allsearch" name = "allsearch" class="typeahead form-control"
                                    placeholder="Enter Name / Student" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row all ctc">
                            <div class="col-lg-4 col-sm-12 col-xs-12 mb-3">
                                ...
                                <input type = "text" class = "form-control" name = "TransferAddress"
                                    id = "TransferAddress">
                            </div>
                        </div>
                        ...
                        <div class="row all orno">
                            ...
                            <div class=" col-lg-2 col-sm-6 col-xs-12 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="addon-orno1" data-bs-toggle="offcanvas"
                                        data-bs-target="#offcanvassearchOR"><i class='bx bx-search-alt-2'></i></span>
                                    <input readonly name = "ORNo" id = "ORNo" type="number" class="form-control"
                                        placeholder="ORNo" aria-label="ORNo" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                        ...
                        <div class="row all docorno">
                            ...
                            <div class=" col-lg-2 col-sm-6 col-xs-12 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="addon-orno2" data-bs-toggle="offcanvas"
                                        data-bs-target="#offcanvassearchOR"><i class='bx bx-search-alt-2'></i></span>
                                    <input readonly name = "DocORNo" id = "DocORNo" type="number" class="form-control"
                                        placeholder="DocORNo" aria-label="DocORNo" aria-describedby="addon-wrapping">
                                </div>
                            </div>

                            <div class="col-lg-2 col-sm-6 col-xs-12 mb-3">
                                <label for="DocORDate" class="form-label">Doc Stamp Date Paid</label>
                                <input readonly type = "date" class = "form-control" name = "DocORDate"
                                    id = "DocORDate">
                            </div>
