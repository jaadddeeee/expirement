                  ...
                  <tbody>
                    @foreach($scholars as $scholar)
                      <tr>
                        ...
                        <td class = "text-nowrap text-end pe-5">{{(empty($scholar->amount)?"":($scholar->typ==1?$scholar->amount."%":number_format($scholar->amount, 2, '.',',')))}}</td>
                        <td class = "text-nowrap">{{GENERAL::Scholarships()[$scholar->typ]['Description']}}</td>
                      </tr>
                    @endforeach
                  </tbody>
              </table>
