    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        ...
        <div class="card-action">
            {!! $headerAction ?? '' !!}
            <a href = "#" class = "btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalLibrary">New</a>
                ...
                <table id = "myTable" class = "table table-sm">
                    ...
                    @foreach($depts as $dept)
                        ...
                        <tr>
                            ...
                            <td class = "text-nowrap">{!!"<strong>".$dept->StudentNo. '</strong> ' . (empty($dept->student->LastName)?'Invalid Student No':utf8_decode($dept->student->LastName.', '.$dept->student->FirstName . ' '.(empty($dept->student->MiddleName)?"":$dept->student->MiddleName[0])))!!}</td>
                            <td class = "text-nowrap">{{(empty($dept->student->LastName)?"Invalid Student No":utf8_decode($dept->student->course->accro.(isset($dept->student->Major->course_major)?" - ".$dept->student->Major->course_major:"")))}}</td>
