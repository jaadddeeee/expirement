    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        <div class="header-title">
          ...
          <span class = "text-primary">{{$Role}} / {{$DepartmentName}}</span>
        </div>
        <div class="card-action">
            {!! $headerAction ?? '' !!}
            <a href = "#" class = "btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeparment">New</a>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasImportFile" aria-labelledby="offcanvasBackdropLabel">
  ...
  <form id = "frmImportBulkDepartment" enctype="multipart/form-data">
...
@include('slsu.modals.department');

@section('page-script')
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.1/bootstrap3-typeahead.min.js"></script>
<script src="{{asset('storage/js/clearance.js?id=202301225')}}"></script>
