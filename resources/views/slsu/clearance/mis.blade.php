    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        ...
        <div class="card-action">
            {!! $headerAction ?? '' !!}
            <a href = "#" class = "btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalMIS">New</a>
                ...
                <table class = "table table-sm">
                    ...
                    @foreach($depts as $dept)
                        ...
                        <tr>
                            ...
                            <td class = "text-nowrap">{!!"<strong>".$dept->StudentNo. '</strong> ' . (isset($dept->student->LastName)?utf8_decode($dept->student->LastName.', '.$dept->student->FirstName . ' '.(empty($dept->student->MiddleName)?"":$dept->student->MiddleName[0])):"Error Student")!!}</td>
                            <td class = "text-nowrap">{{(isset($dept->student->course)?utf8_decode($dept->student->course->accro.(isset($dept->student->Major->course_major)?" - ".$dept->student->Major->course_major:"")):"")}}</td>
...
@include('slsu.modals.mis');

@section('page-script')
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.1/bootstrap3-typeahead.min.js"></script>
<script src="{{asset('storage/js/mis.js?id=20231225')}}"></script>
