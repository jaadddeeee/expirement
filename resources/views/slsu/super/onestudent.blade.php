...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb breadcrumb-style1">
    ...
    <li class="breadcrumb-item">
      <a href="javascript:void(0);">{{GENERAL::Campuses()[$campus]['Campus']}}</a>
    </li>
    <li class="breadcrumb-item">
    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        <div class="header-title">
          ...
          <label><i class = "fa fa-mobile"></i> {{(empty($one->ContactNo)?"No registered mobile":$one->ContactNo)}} <i class = "fa fa-send-o"></i> {!!(empty($one->email)?"No e-mail registered":'<a href = "mailto:'.$one->email.'">'.$one->email.'</a>')!!}</label><br>
          <label>{{$age}} years old
        </div>
