...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="defaultSelect" class="form-label">External</label>
                        <select id="defaultSelect" class="form-select">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddScholar"
            ...
            <form id = "frmAddScholarship">
                <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                    ...
                    <input type="text" name = "ScholarshipName" class = "mb-4 form-control"
