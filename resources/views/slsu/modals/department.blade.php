<div class="modal fade" id="modalDeparment" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id = "btnAddDepartmentReason" class="btn btn-primary">Add to list</button>
      </div>
    </div>
  </div>
</div>
