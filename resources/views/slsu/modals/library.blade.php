<div class="modal fade" id="modalLibrary" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel1">Library</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
          <form id = "frmAddLibrary">
            @csrf
            <div id = "msg"></div>
            <div class="row">
              <div class="col mb-3">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id = "btnAddLibraryReason" class="btn btn-primary">Add to list</button>
      </div>
    </div>
  </div>
</div>
